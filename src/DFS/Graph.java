...
class Node {
    public int num;
    public HashMap<Integer, Edge> fanout; // Key is int. Value is b.Edge
    public HashMap<Integer, Edge> fanin; // Key is int. Value is b.Edge
...
class Graph {
    ...
    public boolean assertDFS(boolean cycle, ArrayList<Integer> dfsorder) {
        ...
        if (cycle == false) {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                Node n = nodes.get(v);
                //fanin = new HashMap<Integer,b.Edge>();
                //Key is Integer, value is b.Edge
    ...
    public void dfsUsingTimeStamp(int[] work, boolean[] cycle, ArrayList<Integer> topologicalOrderArray, String f) {
        GraphDFSUsingTimeStamp g = new GraphDFSUsingTimeStamp(this, work, cycle, topologicalOrderArray, f);
    }

    public static void main(String[] args) {
        System.out.println("Use b.GraphTest.java to test");
    }
}